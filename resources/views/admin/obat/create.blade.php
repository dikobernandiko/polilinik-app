                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="kemasan" id="kemasan" class="form-control @error('kemasan') is-invalid @enderror" value="{{ old('kemasan') }}" placeholder="Contoh: Strip, Botol, Tube" required>
                                            @error('kemasan')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
